...
const Footer: React.FC = () => (  
    <footer className="flex flex-col md:grid md:grid-cols-2 py-8 px-4 w-screen h-fit relative bg-[#1e1e1e]">
        ...
        <section className='flex flex-col gap-2 pt-8 md:justify-end'>
