...
export default function Circles() {
  return(
    <>
      <head>
        <title>Circles – A Social App for Close Friends</title>
        <meta name="description" content="A social app built for close friends, focused on private sharing and meaningful connection." />
        <meta property="og:title" content="Circles | Dear Neighbour" />
        <meta property="og:description" content="A quiet, private space to share and connect with the people who matter most." />
        <meta property="og:image" content="/images/seo/circles.png" />
