    ...
    return (
        <>
            ...
            <div>
                ...
                <p className="text-center text-xl font-['FavoritMono'] mt-10 mb-8 md:max-w-8/12 tracking-tighter text-gray">
            ...
            <section className="flex flex-col items-center relative">
                ...
                <div className="flex flex-col items-center justify-center space-y-4 absolute bottom-0 top-0 pl-2 md:pl-20">
                    <div>
                    <h6
                        className="opacity-80 text-center justify-center text-stone-900/75 md:text-2xl font-['FavoritMono']"
                    >
                        EMAIL                         
                    </h6>
                        <a
                            href="mailto:dear.neighbour@outlook.ca"
                            className="text-darkgrey hover:underline md:text-4xl font-['Roobert'] text-center"
                        >
